...
Scenario: Test if I can spend immature foundation's coin
  ...
  And I make <6> blocks
  Then I spend the foundation's transaction on the height <5> plus <0>
...
Scenario: Test if I can spend more foundation's coin than I have
  ...
  Then I spend the foundation's transaction on the height <5> plus <10>
...
Scenario: Test if I can spend foundation's transaction made after of fork
  ...
  Then I spend the foundation's transaction on the height <20> plus <0>
